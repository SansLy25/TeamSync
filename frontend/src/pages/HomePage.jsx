...
function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto animate-fade-in">
      <section className="relative overflow-hidden rounded-xl bg-gradient-to-r from-primary-900 via-secondary-900 to-dark-800 p-8 md:p-12 mb-10">
        <div className="relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Найди свою идеальную <span className="text-primary-400">команду</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-xl">
            Объединяйся с игроками твоего уровня, расписания и целей. Подними свой игровой опыт на новый уровень с правильными тиммейтами.
          </p>
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full opacity-20">
          <div className="absolute top-1/4 right-1/4 w-40 h-40 rounded-full bg-primary-500 filter blur-3xl"></div>
          <div className="absolute bottom-1/4 right-1/3 w-60 h-60 rounded-full bg-secondary-500 filter blur-3xl"></div>
        </div>
      </section>
      ...
      <section className="mb-16">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/lobbies" className="text-primary-400 hover:text-primary-300 flex items-center transition">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {popularGames.map((game, index) => (
            ...
            >
              <div className="h-12 w-12 bg-gradient-to-br from-primary-600 to-secondary-600 rounded-full mx-auto mb-3 flex items-center justify-center">
      ...
      <section className="bg-gradient-to-r from-secondary-900 to-primary-900 rounded-xl p-8 text-center mb-16">
        ...
        <p className="text-gray-300 mb-6 max-w-xl mx-auto">
          Присоединяйся к тысячам игроков, которые ищут таких же тиммейтов, как ты. Создай профиль и начни общение прямо сейчас.
        </p>
        <Link to={isAuthenticated ? "/create-lobby" : "/register"} className="btn btn-accent inline-flex items-center">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="rounded-full bg-dark-700 border-4 border-primary-500 w-16 h-16 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="text-center">
            <div className="rounded-full bg-dark-700 border-4 border-secondary-500 w-16 h-16 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="text-center">
            <div className="rounded-full bg-dark-700 border-4 border-accent-500 w-16 h-16 flex items-center justify-center mx-auto mb-4">
