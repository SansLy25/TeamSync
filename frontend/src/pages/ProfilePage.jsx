                  ...
                  {!isEditing ? (
                    <>
                      <div className="mb-4">
                        ...
                        <p className="text-gray-300">{userProfile.bio || 'No bio provided yet.'}</p>
                      </div>
                      ...
                      <div className="space-y-2 mt-4">
                        ...
                        {userProfile.contacts?.telegram && (
                          <div className="flex items-center text-sm">
                            ...
                            <span className="text-gray-300">{userProfile.contacts.telegram}</span>
                          </div>
                        )}
                        ...
                        {userProfile.contacts?.discord && (
                          <div className="flex items-center text-sm">
                            ...
                            <span className="text-gray-300">{userProfile.contacts.discord}</span>
                          </div>
                        )}
                        ...
                        {userProfile.contacts?.steam && (
                          <div className="flex items-center text-sm">
                            ...
                            <span className="text-gray-300">{userProfile.contacts.steam}</span>
                          </div>
                        )}
              ...
              {activeTab === 'lobbies' ? (
                joinedLobbies.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium mb-2">Вы не присоеденены ни к одному лобби</h3>
