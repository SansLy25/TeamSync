...
import { Eye, EyeOff, User, Lock, Info, AtSign, DiscIcon as BrandDiscord, PoundSterling as BrandSteam } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {errors.confirmPassword && <p className="text-error-400 text-sm mt-1">{errors.confirmPassword}</p>}
            </div>
          </div>
          ...
          {/* Секция контактов */}
          <div className="space-y-4">
            <h2 className="text-lg font-semibold border-b border-dark-500 pb-2">Контактная информация (необязательно)</h2>
